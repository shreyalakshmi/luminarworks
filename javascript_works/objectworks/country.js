...
//   console.log(countries[0]);         //[0] bcz first country details
var data = [];
for (let country of countries) {
  ...
  if ("currencies" in country) {
    currencyName = country.currencies[0].name            //bcz an array
  }
  // console.log(`country name=${countryName}, population=${population}, capital=${capital}, currency=${currencyName}`);
  let myCountry = { countryName, population, capital, currencyName }
  data.push(myCountry);
}
console.log(data);
...
data.forEach(mydata=>console.log(mydata.countryName))
...
let india=data.find(indata=>indata.countryName=="India")
// console.log(india);

let china=data.find(chinadata=>chinadata.countryName=="China").currencyName
// console.log(china);

let abovetwo=data.filter(popdata=>popdata.population>=20000000).map(name=>name.countryName)
